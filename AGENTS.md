...
# Agent Router: MacZones

Router for MacZones, a minimal window zone snapping app for macOS. The
profile lives in the vault.

## Always Read In This Order

1. `../workspace-wiki/agents/README.md`: the shared reading chain of the ProjectMakers vault
2. `../workspace-wiki/projects/maczones/README.md`: this project's page in the vault
3. [README.md](README.md): features, build and usage
